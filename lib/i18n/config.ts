...
/**
 * Подпись для переключателя языка в шапке — родное название языка
 * (W3C "Choosing a Language Tag"/i18n-практика: «Тоҷикӣ», а не код/аббревиатура).
 * Читатель узнаёт свой язык мгновенно; аббревиатуру «ТҶ» приходилось
 * расшифровывать, «TG/RU»-коды — тем более.
 */
