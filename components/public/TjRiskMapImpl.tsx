 ...
 *
 * Реализация — всегда грузится лениво через `TjRiskMap.tsx` (d3-geo +
 * topojson-client весят ~15-18 КБ gzip, на 4 маршрутах, которые эту карту
 * не используют, платить за это незачем).
 */
export default function TjRiskMapImpl({
  regions = [],
  height = 480,
  showLabels = true,
}: {
