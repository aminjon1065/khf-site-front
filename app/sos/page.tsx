...
import { sos, type AppFeature } from "./content";

export const metadata = { title: "Приложение SOS" };
...
export default function SosPage() {
  ...
  return (
    <PageShell active="">
      ...
      <section aria-label="Возможности" className="mt-14">
